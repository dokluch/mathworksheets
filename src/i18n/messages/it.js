...
export default {
  ...
  app: {
    ...
    allGrades: 'Tutte',
    ages: '{ages} anni',
    sheetCount: { one: '{n} scheda', other: '{n} schede' },
  },
  ...
  bongard: {
    ...
    rules: {
      ...
      bp011: 'Sinistra: figure sottili, lunghe e strette anche quando si piegano. Destra: figure tozze e compatte.',
      bp012: 'Sinistra: la figura nel suo insieme è lunga e stretta. Destra: la figura nel suo insieme è larga circa quanto è lunga, punte e aperture comprese.',
      bp013: 'Sinistra: rettangoli in piedi ed ellissi sdraiate. Destra: rettangoli sdraiati ed ellissi in piedi.',
      bp014: 'Sinistra: è disegnata molta linea. Destra: è disegnata poca linea.',
      bp015: 'Sinistra: figure chiuse. Destra: figure con un’apertura nella linea.',
      bp016: 'Sinistra: seguita dall’estremità esterna verso l’interno, la spirale gira in senso antiorario. Destra: gira in senso orario.',
      bp017: 'Sinistra: un angolo del contorno punta verso l’interno della figura. Destra: nessun angolo punta verso l’interno, anche se un lato può curvarsi in dentro.',
      bp018: 'Sinistra: la figura si restringe in un collo. Destra: figure senza collo.',
      bp019: 'Sinistra: il collo va da un lato all’altro. Destra: il collo va dall’alto in basso.',
      bp020: 'Sinistra: i due punti stanno sulla stessa parte della figura. Destra: un collo separa i due punti.',
      bp021: 'Sinistra: nella casella c’è una figura piccola. Destra: non ci sono figure piccole.',
      bp022: 'Sinistra: tutte le figure hanno la stessa grandezza. Destra: le figure hanno grandezze diverse.',
      bp023: 'Sinistra: una figura. Destra: due figure.',
      bp024: 'Sinistra: tra le figure c’è un cerchio. Destra: non ci sono cerchi.',
      bp025: 'Sinistra: la figura nera è un triangolo. Destra: la figura nera è un cerchio.',
      bp026: 'Sinistra: c’è un triangolo nero. Destra: non ci sono triangoli neri.',
      bp027: 'Sinistra: più figure nere che bianche. Destra: più figure bianche che nere.',
      bp028: 'Sinistra: più cerchi neri che cerchi bianchi. Destra: più cerchi bianchi che cerchi neri.',
      bp029: 'Sinistra: più cerchietti dentro la figura grande che fuori. Destra: più cerchietti fuori che dentro.',
      bp030: 'Sinistra: la linea si incrocia con se stessa. Destra: la linea non si incrocia mai con se stessa.',
      bp031: 'Sinistra: una sola linea. Destra: due linee.',
      bp032: 'Sinistra: una punta acuta sporge dalla figura. Destra: nessuna punta acuta sporge, comunque siano gli angoli all’interno.',
      bp033: 'Sinistra: la figura ha un angolo acuto, rivolto verso dentro o verso fuori. Destra: nessun angolo è acuto.',
      bp034: 'Sinistra: un buco grande nella figura nera. Destra: un buco piccolo.',
      bp035: 'Sinistra: la fessura va nello stesso verso della figura. Destra: la fessura va di traverso alla figura.',
      bp036: 'Sinistra: il triangolo è sopra il cerchio. Destra: il cerchio è sopra il triangolo.',
      bp037: 'Sinistra: il triangolo è sopra il cerchio, ovunque sia il quadrato. Destra: il cerchio è sopra il triangolo.',
      bp038: 'Sinistra: il triangolo è più grande del cerchio. Destra: il cerchio è più grande del triangolo.',
      bp039: 'Sinistra: i tre segmenti vanno più o meno nella stessa direzione. Destra: i segmenti formano angoli ampi tra loro.',
      bp040: 'Sinistra: tre dei punti stanno su una stessa linea retta. Destra: non ci sono tre punti allineati.',
      bp041: 'Sinistra: i cerchi bianchi stanno su una stessa linea retta. Destra: i cerchi bianchi no, qualunque cosa facciano i punti neri.',
      bp042: 'Sinistra: i punti dentro la figura stanno su una stessa linea retta. Destra: i punti dentro la figura non sono allineati.',
      bp043: 'Sinistra: l’onda cresce da sinistra a destra. Destra: l’onda si riduce da sinistra a destra.',
      bp044: 'Sinistra: i due cerchietti stanno su archi diversi della linea. Destra: i due cerchietti stanno sullo stesso arco.',
      bp045: 'Sinistra: la figura a contorno sta sopra quella nera, coprendola. Destra: la figura nera sta sopra quella a contorno, coprendola.',
      bp046: 'Sinistra: il triangolo sta sopra il cerchio, coprendolo. Destra: il cerchio sta sopra il triangolo, coprendolo.',
      bp047: 'Sinistra: un triangolo dentro il cerchio. Destra: un cerchio dentro il triangolo.',
      bp048: 'Sinistra: ogni figura nera è più in alto di ogni figura bianca. Destra: ogni figura bianca è più in alto di ogni figura nera.',
      bp049: 'Sinistra: i punti dentro la figura sono vicini tra loro e quelli fuori sparsi. Destra: i punti fuori sono vicini tra loro e quelli dentro sparsi.',
      bp050: 'Sinistra: il disegno è simmetrico rispetto a una linea verticale. Destra: il disegno non è simmetrico.',
    },
  },
  ...
  worksheets: {
    bongard: {
      ...
      shortDesc: 'Trova ciò che le caselle a sinistra hanno in comune e a quelle a destra manca',
