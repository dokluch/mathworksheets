...
export default {
  ...
  topics: {
    ...
    numbers: 'Sens du nombre',
    fractions: 'Fractions et décimaux',
    algebra: 'Algèbre',
    logic: 'Suites et logique',
  },
  ...
  worksheets: {
    ...
    decimals: {
      ...
      longDesc: 'Des exercices sur les nombres décimaux sur un quadrillage de cahier, en deux modes. Le mode posé additionne et soustrait des décimaux avec la virgule posée sur la ligne du quadrillage entre les unités et les dixièmes, comme dans un cahier, pour que l’enfant aligne 3,8 sous 12,75 par la virgule et non par le dernier chiffre ; au choix un chiffre après la virgule, deux, ou un mélange. Le mode puissances multiplie et divise par 10, 100 et 1000 : la virgule se déplace : la réponse a une case par chiffre et l’enfant place la virgule. Le séparateur s’imprime en virgule ou en point, selon l’usage de chaque langue.',
