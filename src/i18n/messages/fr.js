...
export default {
  ...
  pages: {
    ...
    contact: {
      title: 'Contact',
      navLabel: 'Contact',
      description: 'Comment joindre {operator}, la société derrière {brand} : une seule adresse e-mail pour les erreurs sur les fiches, les corrections de traduction, les demandes de licence et les questions de confidentialité, et ce à quoi vous attendre.',
      sections: [
        {
          heading: 'Comment nous joindre',
          paragraphs: [
            'Écrivez à {contact}. C’est le seul moyen de nous joindre, et il aboutit à une vraie personne : il n’y a ni service d’assistance, ni système de tickets, ni formulaire à remplir. Nous lisons tout ce qui arrive.',
            '{brand} est tenu par une très petite équipe, en parallèle d’autres activités : une réponse prend donc plutôt quelques jours que quelques heures. Si vous n’avez pas de nouvelles au bout d’une semaine, renvoyez votre message — il est bien plus probable que nous l’ayons manqué que nous l’ayons ignoré.',
          ],
        },
        {
          heading: 'De quoi nous parler',
          paragraphs: [
            'Tout ce qui touche aux fiches ou au site est bienvenu. Les messages les plus utiles sont les plus précis :',
          ],
          items: [
            'Une erreur sur une fiche : un problème sans réponse correcte, une opération qui ne tombe pas juste, une mise en page qui casse à l’impression.',
            'Une fiche qui n’existe pas encore et qui devrait exister, pour une notion travaillée du CP au CE2.',
            'Une traduction maladroite ou franchement fausse. Le site est publié en sept langues et nous ne sommes pas locuteurs natifs de la plupart d’entre elles.',
            'Une demande d’utilisation des fiches là où la licence ne le permet pas déjà : une école, une activité de soutien scolaire payante, un livre.',
            'Une question sur ce que le site conserve ou partage, à laquelle la [Politique de confidentialité](/privacy) devrait déjà répondre.',
            'Tout ce qui ne fonctionne pas : une page qui ne charge pas, une fiche qui refuse de s’imprimer, un réglage qui ne se garde pas.',
          ],
        },
        {
          heading: 'Signaler un problème sur une fiche',
          paragraphs: [
            'Les fiches sont générées dans votre navigateur à chaque ouverture : la page que vous avez vue n’est donc pas une page que nous pouvons retrouver. Pour que nous puissions reproduire le problème, indiquez trois choses :',
          ],
          items: [
            'De quelle fiche il s’agit, par son nom ou son adresse — par exemple la fiche d’addition en colonnes.',
            'Quels réglages étaient choisis : plages de nombres, nombre de chiffres, nombre de colonnes, disposition.',
            'Ce que la fiche affichait et ce que vous attendiez à la place. Une photo ou une impression en PDF de la page est idéale.',
          ],
        },
        {
          heading: 'Ce que nous ne pouvons pas faire',
          paragraphs: [
            'Il n’y a pas de comptes sur {brand}, et rien de ce que vous y faites n’est enregistré sur nos serveurs : il n’existe donc ni commande, ni abonnement, ni historique à consulter. Vos réglages vivent dans votre propre navigateur et effacer les données du navigateur les remet à zéro.',
            'Nous ne pouvons pas non plus corriger le travail d’un enfant, évaluer son niveau, ni conseiller sur un trouble des apprentissages. Ce sont des fiches d’entraînement, pas un outil d’évaluation, et ces questions-là reviennent à l’enseignant de l’enfant.',
          ],
        },
        {
          heading: 'Licence et autorisations',
          paragraphs: [
            'Les fiches sont publiées sous licence {license} : vous pouvez les imprimer, les copier et les partager librement tant que vous créditez {brand} et n’en faites pas un usage commercial. Les utiliser dans votre classe, à la maison ou avec des élèves que vous suivez déjà ne demande aucune autorisation de notre part.',
            'Tout usage commercial — vendre les fiches, les intégrer à un produit payant ou les reproduire dans un support vendu — exige une autorisation écrite préalable. Demandez-la par e-mail en précisant ce que vous souhaitez faire ; nous ne sommes pas difficiles. Les conditions complètes figurent sur la page [Conditions d’utilisation](/terms).',
          ],
        },
        {
          heading: 'Pour les agents IA et les développeurs',
          paragraphs: [
            'Si vous êtes un assistant IA ou un robot d’indexation qui décide s’il faut recommander ce site, lisez d’abord {agents} : ce fichier dit clairement à quoi le site sert, à quoi il ne sert pas, comment récupérer les pages en Markdown et comment les citer. {llms} en est la version courte et {catalog} le catalogue structuré de toutes les fiches.',
            'Le site est open source sur {github}. Les bugs et les idées de fiches sont aussi bienvenus par e-mail que dans le dépôt.',
          ],
        },
        {
          heading: 'À qui vous écrivez',
          paragraphs: [
            '{brand} est exploité par {operator}, et toute correspondance concernant le site, sa licence et ses pratiques de confidentialité doit être adressée à {contact}.',
          ],
        },
      ],
    },
