...
export default {
  ...
  worksheets: {
    ...
    decimals: {
      ...
      longDesc: 'Dezimalzahlen üben auf einem Karogitter, in zwei Modi. Der schriftliche Modus addiert und subtrahiert Dezimalzahlen mit dem Komma auf der Kästchenlinie zwischen Einern und Zehnteln, wie im Rechenheft, damit ein Kind 3,8 am Komma unter 12,75 ausrichtet und nicht an der letzten Ziffer; wählbar sind eine Nachkommastelle, zwei oder gemischt. Der Stellenwert-Modus multipliziert und dividiert mit 10, 100 und 1000: Das Komma verschiebt sich: Das Ergebnis hat ein Kästchen pro Ziffer, und das Kind setzt das Komma selbst. Das Dezimaltrennzeichen wird je nach Sprache als Komma oder Punkt gedruckt.',
      ...
      faq: [
        { q: 'Warum schreibt man die Kommas untereinander und nicht die letzten Ziffern?', a: 'Bei ganzen Zahlen stehen die letzten Ziffern untereinander, weil sie alle Einer sind. Bei Dezimalzahlen kann die letzte Ziffer in der einen Zahl Zehntel und in der anderen Hundertstel sein, also markiert das Komma die Einerspalte. 12,75 + 3,8 geht schief, sobald die 8 unter der 5 steht, und ein Komma, das in jeder Zeile auf derselben Kästchenlinie steht, macht diesen Fehler schwer.' },
