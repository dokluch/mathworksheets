...
export default {
  ...
  pages: {
    ...
    contact: {
      title: 'Contacto',
      navLabel: 'Contacto',
      description: 'Cómo ponerte en contacto con {operator}, la empresa detrás de {brand}: una sola dirección de correo para errores en las hojas, correcciones de traducción, solicitudes de licencia y preguntas sobre privacidad, y qué esperar cuando escribes.',
      sections: [
        {
          heading: 'Cómo contactarnos',
          paragraphs: [
            'Escribe a {contact}. Es la única forma de localizarnos, y llega a una persona de verdad: no hay servicio de soporte, ni sistema de tickets, ni formulario que rellenar. Leemos todo lo que llega.',
            '{brand} lo lleva un equipo muy pequeño en paralelo a otros trabajos, así que una respuesta suele tardar unos días en lugar de unas horas. Si en una semana no has recibido nada, vuelve a escribir: es mucho más probable que se nos haya pasado a que te hayamos ignorado.',
          ],
        },
        {
          heading: 'Sobre qué escribirnos',
          paragraphs: [
            'Cualquier cosa sobre las hojas o el sitio es bienvenida. Los mensajes que más ayudan son los concretos:',
          ],
          items: [
            'Un fallo en una hoja: un problema sin respuesta correcta, una suma que no cuadra, una maquetación que se rompe al imprimir.',
            'Una hoja que todavía no existe y debería existir, para una destreza que un niño de 1.º a 3.º está trabajando.',
            'Una traducción que suena mal o es directamente incorrecta. El sitio se publica en siete idiomas y no somos hablantes nativos de la mayoría.',
            'Una petición para usar las hojas donde la licencia no lo cubre ya: un colegio, una academia o clases particulares de pago, un libro.',
            'Una duda sobre qué guarda o comparte el sitio, que la [Política de privacidad](/privacy) debería responder primero.',
            'Cualquier cosa que no funcione: una página que no carga, una hoja que no se imprime, un ajuste que no se guarda.',
          ],
        },
        {
          heading: 'Informar de un problema en una hoja',
          paragraphs: [
            'Las hojas se generan de nuevo en tu navegador cada vez, así que la página que viste no es una página que podamos consultar. Para que podamos reproducir el problema, cuéntanos tres cosas:',
          ],
          items: [
            'Qué hoja es, por su nombre o su dirección: por ejemplo, la hoja de suma en columna.',
            'Qué ajustes estaban seleccionados: rangos de números, cifras, número de columnas, disposición.',
            'Qué mostraba la hoja y qué esperabas en su lugar. Una foto o la página impresa en PDF es lo ideal.',
          ],
        },
        {
          heading: 'Con qué no podemos ayudar',
          paragraphs: [
            'En {brand} no hay cuentas, y nada de lo que haces aquí se guarda en nuestros servidores, así que no existe ningún pedido, suscripción ni historial que podamos consultar. Tus ajustes viven en tu propio navegador y borrar los datos del navegador los reinicia.',
            'Tampoco podemos corregir el trabajo de un niño, valorar cómo va ni asesorar sobre una dificultad de aprendizaje. Son hojas de práctica, no una herramienta de evaluación, y esas preguntas corresponden al maestro del niño.',
          ],
        },
        {
          heading: 'Licencia y permisos',
          paragraphs: [
            'Las hojas se publican bajo {license}: puedes imprimirlas, copiarlas y compartirlas libremente siempre que cites a {brand} y no las uses con fines comerciales. Usarlas en tu aula, en casa o con alumnos a los que ya das clase no necesita permiso nuestro.',
            'Cualquier uso comercial —vender las hojas, incluirlas en un producto de pago o reimprimirlas en material que se vende— necesita permiso por escrito previo. Pídelo por correo y cuéntanos qué quieres hacer; no somos difíciles. Los términos completos están en la página de [Términos del servicio](/terms).',
          ],
        },
        {
          heading: 'Para agentes de IA y desarrolladores',
          paragraphs: [
            'Si eres un asistente de IA o un rastreador que decide si recomendar este sitio, lee primero {agents}: dice con claridad para qué sirve el sitio, para qué no sirve, cómo obtener las páginas en Markdown y cómo citarlas. {llms} es la versión corta y {catalog} es el catálogo estructurado de todas las hojas.',
            'El sitio es de código abierto en {github}. Los errores y las ideas de hojas son igual de bienvenidos por correo que en el repositorio.',
          ],
        },
        {
          heading: 'A quién escribes',
          paragraphs: [
            '{brand} está operado por {operator}, y la correspondencia sobre el sitio, su licencia y sus prácticas de privacidad debe dirigirse a {contact}.',
          ],
        },
      ],
    },
