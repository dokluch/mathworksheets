...
export default {
  ...
  static: {
    ...
    home: {
      ...
      intro2: 'The catalog covers multiplication tables, addition and subtraction drills with missing numbers, vertical column addition and subtraction with carrying and borrowing, long multiplication, division facts with and without remainders, long division, comparing numbers with >, < and =, rounding to the nearest 10, 100 and 1000, number patterns, multi-step expressions where the order of operations decides the answer, and for grades 4 to 6 fractions, decimals, prime factorization with GCD and LCM, and equations to solve for x. The Equation Explorer is an on-screen activity where children move terms across the equals sign and check their answer on a number line.',
