...
/**
 * Open Graph preview image for a route; generated by `npm run og`
 * (scripts/og-images.mjs). One card per page and locale: English at
 * /og/<slug>.png, the other locales at /og/<locale>/<slug>.png. Static pages
 * (About, Privacy, Terms) reuse their locale's home card.
 */
export function ogImagePath(route) {
  const dir = route.locale === DEFAULT_LOCALE ? '/og' : `/og/${route.locale}`
  if (route.kind === 'worksheet') return `${dir}/${route.worksheet.slug}.png`
  return `${dir}/home.png`
}
    ...
    return {
      ...
      '@graph': [
        ...
        authorNode(),
        {
          ...
          author: { '@id': AUTHOR_ID },
          publisher: { '@id': ORG_ID },
          screenshot: absoluteUrl(ogImagePath(homeRoute(locale))),
          inLanguage: lang,
