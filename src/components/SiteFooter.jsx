...
/**
 * Site footer: About · Privacy · Terms · GitHub and the copyright line.
 * `variant="sidebar"` is the compact form shown under the worksheet list.
  ...
  return (
    <footer className={`site-footer no-print${variant === 'sidebar' ? ' site-footer--sidebar' : ''}`}>
      <nav className="site-footer-links" aria-label="Site">
        {siteFooterLinks().map(l => l.external ? (
